const wordCategories = {
  ...
  adjectives: [
    ...
    { french: "inutile", english: "useless" },
    { french: "utile", english: "useful" },
    { french: "intéressant", english: "interesting" },
    { french: "ennuyeux", english: "boring" },
    { french: "amusant", english: "funny" },
    { french: "sérieux", english: "serious" },
    { french: "drôle", english: "funny" },
    { french: "triste", english: "sad" },
    { french: "heureux", english: "happy" },
    { french: "malheureux", english: "unhappy" },
    { french: "content", english: "content" },
    { french: "mécontent", english: "discontent" },
    { french: "fatigué", english: "tired" },
    { french: "reposé", english: "rested" },
    { french: "malade", english: "sick" },
    { french: "sain", english: "healthy" },
    ...
    { french: "mouillé", english: "wet" },
    { french: "plein", english: "full" },
    { french: "vide", english: "empty" },
    { french: "lourd", english: "heavy" },
    { french: "léger", english: "light" },
    { french: "dur", english: "hard" },
    { french: "mou", english: "soft" },
    { french: "cher", english: "expensive" },
    { french: "bon marché", english: "cheap" },
    { french: "gratuit", english: "free" },
    { french: "payant", english: "paid" },
    { french: "public", english: "public" },
    { french: "privé", english: "private" },
    { french: "national", english: "national" },
    { french: "international", english: "international" },
    { french: "local", english: "local" },
    { french: "global", english: "global" },
    { french: "moderne", english: "modern" },
    { french: "ancien", english: "ancient" },
    { french: "contemporain", english: "contemporary" },
    { french: "traditionnel", english: "traditional" },
    { french: "culturel", english: "cultural" },
    { french: "social", english: "social" },
    { french: "politique", english: "political" },
    { french: "économique", english: "economic" },
    { french: "financier", english: "financial" },
    { french: "commercial", english: "commercial" },
    { french: "industriel", english: "industrial" },
    { french: "agricole", english: "agricultural" },
    { french: "rural", english: "rural" },
    { french: "urbain", english: "urban" },
    { french: "naturel", english: "natural" },
    { french: "artificiel", english: "artificial" },
    { french: "organique", english: "organic" },
    { french: "chimique", english: "chemical" },
    { french: "physique", english: "physical" },
    { french: "mental", english: "mental" },
    { french: "spirituel", english: "spiritual" },
    { french: "religieux", english: "religious" },
    { french: "laïque", english: "secular" },
    { french: "moral", english: "moral" },
    { french: "éthique", english: "ethical" },
    { french: "légal", english: "legal" },
    { french: "illégal", english: "illegal" },
    { french: "juste", english: "fair" },
    { french: "injuste", english: "unfair" },
    { french: "correct", english: "correct" },
    { french: "incorrect", english: "incorrect" },
    { french: "vrai", english: "true" },
    { french: "faux", english: "false" },
    { french: "réel", english: "real" },
    { french: "imaginaire", english: "imaginary" },
    { french: "concret", english: "concrete" },
    { french: "abstrait", english: "abstract" },
    { french: "théorique", english: "theoretical" },
    { french: "pratique", english: "practical" },
    { french: "technique", english: "technical" },
    { french: "scientifique", english: "scientific" },
    { french: "artistique", english: "artistic" },
    { french: "musical", english: "musical" },
    { french: "littéraire", english: "literary" },
    { french: "poétique", english: "poetic" },
    { french: "dramatique", english: "dramatic" },
    { french: "comique", english: "comic" },
    { french: "tragique", english: "tragic" },
    { french: "romantique", english: "romantic" },
    { french: "réaliste", english: "realistic" },
  ...
  adverbs: [
    ...
    { french: "vite", english: "quickly" },
    { french: "lentement", english: "slowly" },
    { french: "ensemble", english: "together" },
    { french: "seul", english: "alone" },
    { french: "presque", english: "almost" },
    { french: "environ", english: "approximately" },
    { french: "exactement", english: "exactly" },
    { french: "surtout", english: "especially" },
    { french: "particulièrement", english: "particularly" },
    ...
    { french: "longtemps", english: "for a long time" },
    { french: "brièvement", english: "briefly" },
    { french: "soudainement", english: "suddenly" },
    { french: "graduellement", english: "gradually" },
    { french: "immédiatement", english: "immediately" },
    { french: "finalement", english: "finally" },
    { french: "initialement", english: "initially" },
    { french: "actuellement", english: "currently" },
    { french: "récemment", english: "recently" },
